...
export class LocaleService {
  ...
  localeData: any = {
    hu: {
      ...
      about: { title: 'rólam', p1: 'Szenvedélyemmé vált a webfejlesztés, ahol egyrészt ki tudom fejezni a kreativitásomat, másrészt meg tudom mutatni a programozói tudásomat is.', p2: 'Szeretek alkotni és látni azt, ahogy egy projekt általam kel életre.', p3: "Örömöm lelem animációk és különféle effektusok készítésében, vagy csupán egy probléma megoldásában.", btn: 'önéletrajz' },
      ...
      portfolio: {
        ...
        t1: 'portfólió',
        projects: [{
          title: 'Angular Material File Input',
